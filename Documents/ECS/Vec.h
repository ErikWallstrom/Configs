...
#define Vec(T) struct { T* buffer; size_t element_size; size_t size; size_t buffer_size; }

#define Vec_insert(vec, pos, ...) Vec_make_space(vec, pos, 1), (vec)->buffer[pos] = __VA_ARGS__
